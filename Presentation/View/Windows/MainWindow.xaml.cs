...
namespace GUIForDiskpart.Presentation.View.Windows
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public void ListVolume_Click(object sender, RoutedEventArgs e) => EListVolume_Click(sender, e);
        public void ListDisk_Click(object sender, RoutedEventArgs e) => EListDisk_Click(sender, e);
        public void ListVDisk_Click(object sender, RoutedEventArgs e) => EListVDisk_Click(sender, e);
        public void CreateVDisk_Click(object sender, RoutedEventArgs e) => ECreateVDisk_Click(sender, e);
        public void AttachVDisk_Click(object sender, RoutedEventArgs e) => EAttachVDisk_Click(sender, e);
        public void ChildVDisk_Click(object sender, RoutedEventArgs e) => EChildVDisk_Click(sender, e);
        public void CopyVDisk_Click(object sender, RoutedEventArgs e) => ECopyVDisk_Click(sender, e);
        public void AttributesVolume_Click(object sender, RoutedEventArgs e) => EAttributesVolume_Click(sender, e);

        #endregion TopBarDiskPartMenu

        #region TopBarCommandsMenu

        public void RetrieveDiskData_Click(object sender, RoutedEventArgs e) => ERetrieveDiskData_Click(sender, e);
        public void ScanVolume_Click(object sender, RoutedEventArgs e) => EScanVolume_Click(sender, e);

        #endregion TopBarCommandsMenu

        #region TopBarFileMenu

        public void SaveLog_Click(object sender, RoutedEventArgs e) => ESaveLog_Click(sender, e);
        public void SaveEntryData_Click(object sender, RoutedEventArgs e) => ESaveEntryData_Click(sender, e);
        public void Quit_Click(object sender, RoutedEventArgs e) => EQuit_Click(sender, e);

        #endregion TopBarFileMenu

        #region TopBarHelpMenu

        public void Website_Click(object sender, RoutedEventArgs e) => EWebsite_Click(sender, e);
        public void Wiki_Click(object sender, RoutedEventArgs e) => EWiki_Click(sender, e);
        public void About_Click(object sender, RoutedEventArgs e) => EAbout_Click(sender, e);
